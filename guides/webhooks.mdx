...
<AccordionGroup>
  ...
  <Accordion icon="copy" title="Handle duplicates">
...
<CardGroup cols={2}>
  ...
  <Card icon="comments" href="/guides/managing-chats" title="Manage chats">
